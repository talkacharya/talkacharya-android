/// Shared 1:1 voice-call layer for the TalkAcharya customer and astrologer apps:
/// a self-hosted WebRTC engine (peer connection + signaling over Centrifugo + ICE
/// restart + heartbeats + quality) and the call screen. Each app injects a
/// [CallBackend], [CallSignaling] and (optionally) a [CallKeepAlive]; networking,
/// routing and DI stay app-side. No third-party media provider.
library;
