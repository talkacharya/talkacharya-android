...
class LoginCubit extends Cubit<LoginState> {
  ...
  static const _genericError = 'Sign-in failed. Please try again.';

  /// Firebase callbacks can land after the login screen is gone — drop those
  /// instead of throwing on a closed cubit.
  @override
