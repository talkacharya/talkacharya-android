...
void main() {
  ...
  group('localized', () {
    test('known codes are translated', () async {
      ...
      final e = _api(400, code: 'otp.invalid');

      expect(localizedErrorFor(en, e), en.errOtpInvalid);
      expect(localizedErrorFor(hi, e), hi.errOtpInvalid);
      expect(localizedErrorFor(hi, e), isNot(en.errOtpInvalid));
    });
